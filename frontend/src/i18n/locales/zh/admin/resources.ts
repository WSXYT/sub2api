export default {
    ...
    relayStations: {
      title: '中转站管理', description: '管理中转站、分组绑定与价格',
      tabs: { stations: '中转站', bindings: '分组绑定与价格', profit: '盈利估计' }, addStation: '新增中转站', testConnection: '测试连接', refreshRates: '刷新价格', saveBindings: '保存绑定',
      columns: { apiKeyName: '上游密钥名称', name: '名称', type: '类型', address: '地址', balance: '余额', status: '状态', actions: '操作', station: '中转站', priority: '优先级', adjustment: '价格修正', accountPools: 'AIHub 套餐池', mode: '路由模式', priceBand: '倍率区间', enabled: '启用', rate: '采集倍率', effectiveRate: '实际倍率', updatedAt: '采集时间', group: '分组', requests: '请求数', totalCost: '基础成本', downstreamRate: '下游倍率', upstreamRate: '上游倍率', revenue: '估计收入', cost: '估计成本', profit: '估计盈利', actualCost: '记录的上游成本', actualProfit: '记录的盈利' },
      types: { aihub: 'aihub-auto', newapi: 'New API', sub2api: 'Sub2API 官方' },
      status: { enabled: '已启用', disabled: '已停用', configured: '已设置', active: '启用', inactive: '停用', ready: '可用', unauthenticated: '认证失败', unavailable: '不可用', stale: '已过期', unknown: '暂无数据' },
      form: { createTitle: '新增中转站', editTitle: '编辑中转站', name: '名称', namePlaceholder: '输入中转站名称', apiKeyName: '默认上游密钥名称', apiKeyNamePlaceholder: '未设置分组名称时使用', type: '类型', baseUrl: 'API 地址', baseUrlPlaceholder: 'https://relay.example.com', controlUrl: '控制台地址', controlUrlPlaceholder: '留空时使用 API 地址', uiPassword: '控制台密码', proxyToken: 'API Token', username: '账号', usernamePlaceholder: '输入平台账号', password: '账号密码', passwordPlaceholder: '输入平台密码', aihubEmail: 'AIHub 邮箱', aihubEmailPlaceholder: '输入 AIHub 平台登录邮箱', enabled: '启用中转站', leaveBlank: '留空保持现有设置' },
      accounts: { title: '中继账号', description: '由中转站提供的账号，优先级高的账号优先使用。', refresh: '刷新', empty: '暂无中继账号', station: '中转站', group: '分组', priority: '优先级', rate: '实际倍率', balance: '余额', status: '状态', manage: '管理' },
      binding: { selectGroup: '选择分组', selectStation: '选择中转站', addSource: '添加中转站', removeSource: '移除', autoSelect: '自动选择最合适的分组', allPools: '全部套餐（不筛选）', selectStationGroup: '选择站点分组', minimum: '最低', maximum: '最高', modes: { economy: '省钱优先', balanced: '均衡', speed: '速度优先' }, lowest: '最低', noGroups: '暂无可绑定分组', noGroupsDescription: '请先在分组管理中创建分组。', noSources: '该分组暂无来源站', noSourcesDescription: '从上方选择一个中转站并添加。', noStationGroups: '该中转站暂无可用分组，请检查连接或账号权限。', groupLoadFailed: '无法加载该中转站的分组。', retryGroups: '重试', groupInvalid: '站点分组名称不能为空、不能超过 100 个字符或包含控制字符', rateAdjustmentInvalid: '倍率修正值必须是有效数字', enableAdjustment: '启用倍率修正', adjustment: '增加', maxRate: '接入上限', noMaxRate: '不限制', maxRateInvalid: '最大倍率必须是非负数字', maxRateExceeded: '超过上限，已禁用', priceBandInvalid: '倍率区间必须为非负数字，且最低值不能高于最高值' },
      profit: { startDate: '开始日期', endDate: '结束日期', load: '查询', unavailable: '暂未启用', unavailableDescription: '后端尚未启用盈利估计。', noData: '暂无盈利估计', noDataDescription: '所选时间范围内没有可估计的数据。', invalidRange: '请选择有效的日期范围', loadFailed: '加载盈利估计失败' },
      empty: { title: '暂无中转站', description: '添加第一个中转站以配置分组绑定。' }, loadFailed: '加载中转站配置失败', saveFailed: '保存中转站失败', createSuccess: '中转站已创建', updateSuccess: '中转站已更新', deleteTitle: '删除中转站', deleteMessage: "确定删除中转站 '{name}' 吗？其分组绑定也会被移除。", deleteSuccess: '中转站已删除', deleteFailed: '删除中转站失败', bindingsSaved: '分组绑定已保存', bindingsSavedWithSyncError: '绑定已保存，但 AIHub 同步失败：{reason}', bindingsSaveFailed: '保存分组绑定失败', ratesRefreshSuccess: '价格已刷新', ratesRefreshPartial: '部分来源价格刷新失败，已保留可用结果', ratesRefreshPartialWithReason: '部分来源价格刷新失败：{reason}', ratesRefreshFailed: '刷新价格失败', testSuccess: '连接成功', testSuccessWithRates: '连接成功，收到 {count} 个价格', testFailed: '连接失败', testFailedWithReason: '连接失败：{reason}'
    },
