export default {
    ...
    relayStations: {
      ...
      columns: { name: '名称', type: '类型', address: '地址', balance: '余额', status: '状态', actions: '操作', station: '中转站', priority: '优先级', adjustment: '价格修正', accountPools: 'AIHub 套餐池', mode: '路由模式', priceBand: '倍率区间', enabled: '启用', rate: '采集倍率', effectiveRate: '实际倍率', updatedAt: '采集时间', group: '分组', requests: '请求数', totalCost: '基础成本', downstreamRate: '下游倍率', upstreamRate: '上游倍率', revenue: '估计收入', cost: '估计成本', profit: '估计盈利', actualCost: '记录的上游成本', actualProfit: '记录的盈利' },
