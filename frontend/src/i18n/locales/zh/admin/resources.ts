export default {
	...
	relayStations: {
		...
		accounts: {
			title: "中继账号",
			description: "由中转站提供的账号，优先级高的账号优先使用。",
			refresh: "刷新",
			empty: "暂无中继账号",
			station: "中转站",
			group: "分组",
		...
		binding: {
			...
			addSource: "添加中转站",
			removeSource: "移除",
			autoSelect: "自动选择最合适的分组",
			allPools: "全部套餐（不筛选）",
			selectStationGroup: "选择站点分组",
			minimum: "最低",
			maximum: "最高",
			modes: {
				economy: "省钱优先",
		...
		bindingsSavedWithSyncError: "分组绑定已保存，但 AIHub 同步失败：{reason}",
		bindingsSaveFailed: "保存分组绑定失败",
		ratesRefreshSuccess: "价格已刷新",
		ratesRefreshPartial: "部分来源价格刷新失败，已保留可用结果",
		ratesRefreshPartialWithReason: "部分来源价格刷新失败：{reason}",
