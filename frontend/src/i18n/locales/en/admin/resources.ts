export default {
	...
	relayStations: {
		...
		columns: {
			...
			accountPools: "AIHub Plans",
			mode: "Routing Mode",
			priceBand: "Rate Range",
			enabled: "Enabled",
			rate: "Collected Rate",
		...
		accounts: {
			...
			description:
				"Accounts provided by relay stations; higher priority is selected first.",
			refresh: "Refresh",
			empty: "No relay accounts",
			station: "Relay Station",
			group: "Group",
			priority: "Priority",
			rate: "Effective Rate",
		...
		binding: {
			...
			addSource: "Add Relay Station",
			removeSource: "Remove",
			autoSelect: "Automatic group selection",
			allPools: "All plans (no filter)",
			selectStationGroup: "Select station group",
			minimum: "Minimum",
			maximum: "Maximum",
			modes: {
			...
			noStationGroups:
				"No usable groups were found. Check the connection or account permissions.",
			groupInvalid:
		...
		empty: {
			...
			description: "Add the first relay station to configure group bindings.",
		},
		...
		deleteMessage:
			"Delete relay station '{name}'? Its group bindings will also be removed.",
		deleteSuccess: "Relay station deleted",
		deleteFailed: "Failed to delete relay station",
		bindingsSaved: "Group bindings saved",
		bindingsSavedWithSyncError: "Bindings saved, but AIHub synchronization failed: {reason}",
		bindingsSaveFailed: "Failed to save group bindings",
		ratesRefreshSuccess: "Prices refreshed",
		ratesRefreshPartial:
			"Some source prices failed to refresh; usable results were kept",
		ratesRefreshPartialWithReason:
			"Some source prices failed to refresh: {reason}",
