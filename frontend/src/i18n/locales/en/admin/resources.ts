export default {
	...
	relayStations: {
		...
		accounts: {
			...
			description: "Accounts provided by relay stations; higher priority is selected first.",
			refresh: "Refresh",
		...
		profit: {
			...
			unavailableDescription:
				"Profit estimation is not enabled by the backend.",
			noData: "No Profit Estimates",
			noDataDescription:
				"There is no estimable data in the selected date range.",
