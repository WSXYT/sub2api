export default {
    ...
    relayStations: {
      ...
      description: 'Manage relay stations, group bindings, and pricing',
      tabs: { stations: 'Relay Stations', bindings: 'Group Bindings & Pricing', profit: 'Profit Estimate' },
      ...
      accounts: { title: 'Relay Accounts', description: 'Accounts provided by relay stations; higher priority is selected first.', refresh: 'Refresh', empty: 'No relay accounts', station: 'Relay Station', group: 'Group', priority: 'Priority', rate: 'Effective Rate', balance: 'Balance', status: 'Status', manage: 'Manage' },
      binding: {
        selectGroup: 'Select Group', selectStation: 'Select Relay Station', addSource: 'Add Relay Station', removeSource: 'Remove', autoSelect: 'Automatic group selection', allPools: 'All plans (no filter)', selectStationGroup: 'Select station group', minimum: 'Minimum', maximum: 'Maximum',
        modes: { economy: 'Economy first', balanced: 'Balanced', speed: 'Speed first' }, lowest: 'Lowest', noGroups: 'No Groups Available', noGroupsDescription: 'Create a group in Group Management first.', noSources: 'No Sources Bound', noSourcesDescription: 'Select a relay station above and add it.', noStationGroups: 'No usable groups were found. Check the connection or account permissions.', groupLoadFailed: 'Could not load this station\'s groups.', retryGroups: 'Retry',
        groupInvalid: 'The station group must be 1-100 characters without control characters', rateAdjustmentInvalid: 'The rate adjustment must be a valid number', enableAdjustment: 'Apply adjustment', adjustment: 'Add', maxRate: 'Routing cap', noMaxRate: 'No cap', maxRateInvalid: 'The maximum rate must be a non-negative number', maxRateExceeded: 'Above cap: disabled', priceBandInvalid: 'The rate range must use non-negative numbers, with minimum no greater than maximum'
      },
      profit: { startDate: 'Start Date', endDate: 'End Date', load: 'Load', unavailable: 'Not Enabled', unavailableDescription: 'Profit estimation is not enabled by the backend.', noData: 'No Profit Estimates', noDataDescription: 'There is no estimable data in the selected date range.', invalidRange: 'Select a valid date range', loadFailed: 'Failed to load profit estimates' },
      empty: { title: 'No Relay Stations', description: 'Add the first relay station to configure group bindings.' },
      loadFailed: 'Failed to load relay station configuration', saveFailed: 'Failed to save relay station', createSuccess: 'Relay station created', updateSuccess: 'Relay station updated', deleteTitle: 'Delete Relay Station', deleteMessage: "Delete relay station '{name}'? Its group bindings will also be removed.", deleteSuccess: 'Relay station deleted', deleteFailed: 'Failed to delete relay station', bindingsSaved: 'Group bindings saved', bindingsSavedWithSyncError: 'Bindings saved, but AIHub synchronization failed: {reason}', bindingsSaveFailed: 'Failed to save group bindings', ratesRefreshSuccess: 'Prices refreshed', ratesRefreshPartial: 'Some source prices failed to refresh; usable results were kept', ratesRefreshPartialWithReason: 'Some source prices failed to refresh: {reason}', ratesRefreshFailed: 'Failed to refresh prices', testSuccess: 'Connection successful', testSuccessWithRates: 'Connection successful; received {count} prices', testFailed: 'Connection failed', testFailedWithReason: 'Connection failed: {reason}'
    },
